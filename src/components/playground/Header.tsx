...
const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="h-12 flex items-center justify-between px-4 border-b-2 bg-card" style={{ borderBottomColor: 'hsl(var(--primary))' }}>
      ...
      <div className="flex items-center gap-2">
        <Select value={outputLanguage} onValueChange={(v) => onOutputLanguageChange(v as 'json' | 'yaml')}>
        ...
        {convertibleTargets.length > 0 && (
          <Select value={convertVersion || `v${inputVersion}`} onValueChange={onConvertVersionChange}>
