...
import { Settings2, Filter, Layers, Wand2, Type, ArrowUpDown, PanelRightClose, PanelRightOpen } from 'lucide-react';
  ...
  if (props.collapsed) {
    return (
      <div className="w-10 flex flex-col items-center py-3 bg-card border-r gap-2">
        ...
        <Button variant="ghost" size="icon" className="h-7 w-7 text-muted-foreground" onClick={props.onToggleCollapse}>
  ...
  return (
    <div className="w-72 flex flex-col bg-card border-r overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto">
        <Accordion type="multiple" defaultValue={["sort", "overlay", "filter", "extra"]} className="px-3">
          {/* SORT OPTIONS */}
          <AccordionItem value="sort">
            ...
            <AccordionContent className="space-y-3 pb-3">
              <div className="flex items-center justify-between">
                ...
                <Switch checked={props.sort} onCheckedChange={props.onSortChange} className="scale-75" />
              </div>

              {props.outputLanguage === 'yaml' && (
                <div className="flex items-center justify-between">
                  <Label className="text-xs">Keep comments</Label>
                  <Switch checked={props.keepComments} onCheckedChange={props.onKeepCommentsChange} className="scale-75" />
                </div>
              )}
              ...
              {props.sort && (
                <>
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-1">
                      <Switch
                        ...
                        className="scale-75"
                      />
                      <Button variant="outline" size="sm" className="h-6 text-[10px] px-2" onClick={props.onOpenSortModal}>
                        Configure
                      </Button>
                    </div>
                  </div>
                  ...
                  <div className="space-y-1">
                    ...
                    <Select value={props.pathSort} onValueChange={(v) => props.onPathSortChange(v as any)}>
          ...
          <AccordionItem value="overlay">
            ...
            <AccordionContent className="space-y-3 pb-3">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-1">
                  <Switch checked={props.toggleOverlay} onCheckedChange={props.onToggleOverlay} className="scale-75" />
                  <Button variant="outline" size="sm" className="h-6 text-[10px] px-2" onClick={props.onOpenOverlayModal}>
                    Configure
                  </Button>
                </div>
              </div>
          ...
          <AccordionItem value="filter">
            ...
            <AccordionContent className="space-y-3 pb-3">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-1">
                  <Switch checked={props.toggleFilter} onCheckedChange={props.onToggleFilter} className="scale-75" />
                  {props.hasFilterFormOptions && (
                    <>
                      ...
                      <Button variant="outline" size="sm" className="h-6 text-[10px] px-2" onClick={props.onDownloadFilter}>
                        Download
                      </Button>
                    </>
                  )}
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch checked={props.filterUnused} onCheckedChange={props.onToggleFilterUnused} className="scale-75" disabled={!props.toggleFilter} />
              </div>
              <div className="flex items-center justify-between">
                <Label className="text-xs">Preserve Empty Objects</Label>
                <Switch checked={props.filterPrevent} onCheckedChange={props.onTogglePreserve} className="scale-75" disabled={!props.toggleFilter} />
              </div>
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="extra">
            ...
            <AccordionContent className="space-y-3 pb-3">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-1">
                  <Switch checked={props.toggleGenerate} onCheckedChange={props.onToggleGenerate} className="scale-75" />
                  <Button variant="outline" size="sm" className="h-6 text-[10px] px-2" onClick={props.onOpenGenerateModal}>
                    Configure
                  </Button>
                </div>
              </div>
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-1">
                  <Switch checked={props.toggleCasing} onCheckedChange={props.onToggleCasing} className="scale-75" />
                  <Button variant="outline" size="sm" className="h-6 text-[10px] px-2" onClick={props.onOpenCasingModal}>
                    Configure
                  </Button>
                </div>
              </div>
